...
function compararLetras(objeto_palavra, objeto_palpite, chavesIguais)
{
    ...
    chavesIguais.forEach(chave => {
        let letraPalavra = objeto_palavra[chave];
        let letraPalpite = objeto_palpite[chave];
        let contador = 0;  // Esse contador impede que uma letra seja indicada visualmente na tela mais vezes do que ela aparece na palavra
